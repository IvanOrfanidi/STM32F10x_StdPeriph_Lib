...
typedef struct {
    ...
    __IO uint8_t SHP
        [12]; /*!< Offset: 0x18  System Handlers Priority Registers (4-7, 8-11, 12-15) */
    __IO uint32_t
    ...
    __I uint32_t PFR
        [2]; /*!< Offset: 0x40  Processor Feature Register                            */
    __I uint32_t
        DFR; /*!< Offset: 0x48  Debug Feature Register                                */
    __I uint32_t
        ADR; /*!< Offset: 0x4C  Auxiliary Feature Register                            */
    __I uint32_t MMFR
        [4]; /*!< Offset: 0x50  Memory Model Feature Register                         */
    __I uint32_t ISAR
        [5]; /*!< Offset: 0x60  ISA Feature Register                                  */
} SCB_Type;
...
#define InterruptType_ICTR_INTLINESNUM_Msk \
    (0x1Ful \
        << InterruptType_ICTR_INTLINESNUM_Pos) /*!< InterruptType ICTR: INTLINESNUM Mask */
...
#define InterruptType_ACTLR_DISFOLD_Msk \
    (1ul \
        << InterruptType_ACTLR_DISFOLD_Pos) /*!< InterruptType ACTLR: DISFOLD Mask */
...
#define InterruptType_ACTLR_DISDEFWBUF_Msk \
    (1ul \
        << InterruptType_ACTLR_DISDEFWBUF_Pos) /*!< InterruptType ACTLR: DISDEFWBUF Mask */
...
#define InterruptType_ACTLR_DISMCYCINT_Msk \
    (1ul \
        << InterruptType_ACTLR_DISMCYCINT_Pos) /*!< InterruptType ACTLR: DISMCYCINT Mask */
