...
typedef struct {
    uint16_t
        TIM_Prescaler; /*!< Specifies the prescaler value used to divide the TIM clock.
    ...
    uint16_t
        TIM_Period; /*!< Specifies the period value to be loaded into the active
    ...
    uint8_t
        TIM_RepetitionCounter; /*!< Specifies the repetition counter value. Each time the RCR downcounter
...
typedef struct {
    uint16_t
        TIM_OSSRState; /*!< Specifies the Off-State selection used in Run mode.
    ...
    uint16_t
        TIM_DeadTime; /*!< Specifies the delay time between the switching-off and the
                                      switching-on of the outputs.
                                      This parameter can be a number between 0x00 and 0xFF  */

    uint16_t
        TIM_Break; /*!< Specifies whether the TIM Break input is enabled or not. 
                                      This parameter can be a value of @ref Break_Input_enable_disable */

    uint16_t
        TIM_BreakPolarity; /*!< Specifies the TIM Break Input pin polarity.
                                      This parameter can be a value of @ref Break_Polarity */

    uint16_t
        TIM_AutomaticOutput; /*!< Specifies whether the TIM Automatic Output feature is enabled or not. 
...
#define IS_TIM_GET_IT(IT) \
    (((IT) == TIM_IT_Update) || ((IT) == TIM_IT_CC1) || \
        ((IT) == TIM_IT_CC2) || ((IT) == TIM_IT_CC3) || \
        ((IT) == TIM_IT_CC4) || ((IT) == TIM_IT_COM) || \
