...
typedef struct {
    ...
    uint16_t
        SPI_FirstBit; /*!< Specifies whether data transfers start from MSB or LSB bit.
...
typedef struct {
    ...
    uint16_t
        I2S_DataFormat; /*!< Specifies the data format for the I2S communication.
                                  This parameter can be a value of @ref I2S_Data_Format */

    uint16_t
        I2S_MCLKOutput; /*!< Specifies whether the I2S MCLK output is enabled or not.
